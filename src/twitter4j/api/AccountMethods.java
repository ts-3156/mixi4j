...
public interface AccountMethods {
     ...
     *
     * @return user
     * @throws mixi4j.MixiException when Twitter service or network is unavailable, or if supplied credential is wrong (TwitterException.getStatusCode() == 401)
     ...
     */
    User verifyCredentials() throws MixiException;
     ...
     */
    RateLimitStatus getRateLimitStatus() throws MixiException;
     ...
     */
    User updateProfileImage(File image) throws MixiException;
     ...
     */
    User updateProfileImage(InputStream image) throws MixiException;
     ...
     */
    AccountTotals getAccountTotals() throws MixiException;
     ...
     * @since Twitter4J 2.1.9
     */
    AccountSettings getAccountSettings() throws MixiException;
     ...
     */
    AccountSettings updateAccountSettings(Integer trendLocationWoeid, Boolean sleepTimeEnabled, String startSleepTime, String endSleepTime, String timeZone, String lang) throws MixiException;
}
