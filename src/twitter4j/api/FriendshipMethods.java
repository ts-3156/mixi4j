...
public interface FriendshipMethods {
     ...
     */
    IDs getIncomingFriendships(long cursor) throws MixiException;
     ...
     * @since Twitter4J 2.1.2
     */
    IDs getOutgoingFriendships(long cursor) throws MixiException;
     ...
     */
    IDs getNoRetweetIds() throws MixiException;
}
