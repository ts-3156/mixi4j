...
public interface UserMethods {
     ...
     */
    ResponseList<User> lookupUsers(String[] screenNames) throws MixiException;
     ...
     * @since Twitter4J 2.1.1
     */
    ResponseList<User> lookupUsers(long[] ids) throws MixiException;
     ...
     */
    ResponseList<User> searchUsers(String query, int page) throws MixiException;
     ...
     * @since Twitter4J 2.1.1
     */
    ResponseList<Category> getSuggestedUserCategories() throws MixiException;
     ...
     * @since Twitter4J 2.1.1
     */
    ResponseList<User> getUserSuggestions(String categorySlug) throws MixiException;
     ...
     */
    ResponseList<User> getMemberSuggestions(String categorySlug) throws MixiException;
     ...
     */
    ProfileImage getProfileImage(String screenName, ProfileImage.ImageSize size) throws MixiException;
