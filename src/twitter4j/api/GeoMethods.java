...
public interface GeoMethods {
     ...
     */
    ResponseList<Place> searchPlaces(GeoQuery query) throws MixiException;
     ...
     * @since Twitter4J 2.1.7
     */
    SimilarPlaces getSimilarPlaces(GeoLocation location, String name, String containedWithin, String streetAddress) throws MixiException;
     ...
     * @since Twitter4J 2.1.1
     */
    ResponseList<Place> reverseGeoCode(GeoQuery query) throws MixiException;

    /**
     * Find out more details of a place that was returned from the {@link twitter4j.api.GeoMethods#reverseGeoCode(mixi4j.GeoQuery)} method.
     ...
     * @since Twitter4J 2.1.1
     */
    Place getGeoDetails(String id) throws MixiException;
