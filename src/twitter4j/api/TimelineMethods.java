...
public interface TimelineMethods {
     ...
     * @throws mixi4j.MixiException when Twitter service or network is unavailable
     ...
     */
    ResponseList<Status> getPublicTimeline() throws MixiException;
     ...
     */
    ResponseList<Status> getHomeTimeline() throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    ResponseList<Status> getHomeTimeline(Paging paging) throws MixiException;
     ...
     */
    ResponseList<Status> getFriendsTimeline() throws MixiException;
     ...
     * @deprecated use {@link #getHomeTimeline(mixi4j.Paging)} instead
     */
    ResponseList<Status> getFriendsTimeline(Paging paging) throws MixiException;
     ...
     * @since Twitter4J 2.0.1
     */
    ResponseList<Status> getUserTimeline(String screenName, Paging paging) throws MixiException;
     ...
     */
    ResponseList<Status> getUserTimeline(long userId, Paging paging) throws MixiException;
     ...
     * @see <a href="https://dev.twitter.com/docs/api/1/get/statuses/user_timeline">GET statuses/user_timeline | Twitter Developers</a>
     */
    ResponseList<Status> getUserTimeline(String screenName) throws MixiException;
     ...
     * @since Twitter4J 2.1.0
     */
    ResponseList<Status> getUserTimeline(long userId) throws MixiException;
     ...
     * @see <a href="https://dev.twitter.com/docs/api/1/get/statuses/user_timeline">GET statuses/user_timeline | Twitter Developers</a>
     */
    ResponseList<Status> getUserTimeline() throws MixiException;
     ...
     * @since Twitter4J 2.0.1
     */
    ResponseList<Status> getUserTimeline(Paging paging) throws MixiException;
     ...
     * @since Twitter4J 2.0.1
     */
    ResponseList<Status> getMentions() throws MixiException;
     ...
     * @since Twitter4J 2.0.1
     */
    ResponseList<Status> getMentions(Paging paging) throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    ResponseList<Status> getRetweetedByMe() throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    ResponseList<Status> getRetweetedByMe(Paging paging) throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    ResponseList<Status> getRetweetedToMe() throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    ResponseList<Status> getRetweetedToMe(Paging paging) throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    ResponseList<Status> getRetweetsOfMe() throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    ResponseList<Status> getRetweetsOfMe(Paging paging) throws MixiException;
