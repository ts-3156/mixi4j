...
public interface ListMembersMethods {
     ...
     * @since Twitter4J 2.1.0
     */
    UserList addUserListMember(int listId, long userId) throws MixiException;
     ...
     */
    UserList addUserListMembers(int listId, long[] userIds) throws MixiException;
     ...
     * @since Twitter4J 2.1.7
     */
    UserList addUserListMembers(int listId, String[] screenNames) throws MixiException;
