...
public interface BlockMethods {
     ...
     */
    User createBlock(String screenName) throws MixiException;
     ...
     */
    User createBlock(long userId) throws MixiException;
     ...
     * @since Twitter4J 2.0.1
     */
    User destroyBlock(String screen_name) throws MixiException;
     ...
     * @since Twitter4J 2.0.1
     */
    User destroyBlock(long userId) throws MixiException;
     ...
     */
    boolean existsBlock(String screenName) throws MixiException;
     ...
     * @since Twitter4J 2.1.0
     */
    boolean existsBlock(long userId) throws MixiException;
     ...
     * @since Twitter4J 2.0.4
     */
    ResponseList<User> getBlockingUsers() throws MixiException;
     ...
     * @since Twitter4J 2.0.4
     */
    ResponseList<User> getBlockingUsers(int page) throws MixiException;
     ...
     * @since Twitter4J 2.0.4
     */
    IDs getBlockingUsersIDs() throws MixiException;
}
