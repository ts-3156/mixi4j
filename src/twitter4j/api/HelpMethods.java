...
public interface HelpMethods {
     ...
     */
    boolean test() throws MixiException;
     ...
     */
    TwitterAPIConfiguration getAPIConfiguration() throws MixiException;
     ...
     * @since Twitter4J 2.2.3
     */
    ResponseList<Language> getLanguages() throws MixiException;
