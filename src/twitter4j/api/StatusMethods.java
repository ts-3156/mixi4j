...
public interface StatusMethods {
     ...
     */
    Status showStatus(long id) throws MixiException;
     ...
     * @since Twitter4J 2.0.1
     */
    Status updateStatus(String status) throws MixiException;
     ...
     */
    Status updateStatus(StatusUpdate latestStatus) throws MixiException;
     ...
     * @since 1.0.5
     */
    Status destroyStatus(long statusId) throws MixiException;
     ...
     */
    Status retweetStatus(long statusId) throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    ResponseList<Status> getRetweets(long statusId) throws MixiException;
     ...
     * @deprecated use {@link #getRetweetedBy(long, mixi4j.Paging)} instead
     */
    ResponseList<User> getRetweetedBy(long statusId) throws MixiException;
     ...
     */
    ResponseList<User> getRetweetedBy(long statusId, Paging paging) throws MixiException;
     ...
     * @since Twitter4J 2.1.3
     * @deprecated use {@link #getRetweetedByIDs(long, mixi4j.Paging)} instead
     */
    IDs getRetweetedByIDs(long statusId) throws MixiException;
     ...
     * @since Twitter4J 2.2.3
     */
    IDs getRetweetedByIDs(long statusId, Paging paging) throws MixiException;
}
