...
public interface LocalTrendsMethods {
     ...
     */
    ResponseList<Location> getAvailableTrends() throws MixiException;
     ...
     * @since Twitter4J 2.1.1
     */
    ResponseList<Location> getAvailableTrends(GeoLocation location) throws MixiException;
     ...
     * @since Twitter4J 2.1.1
     */
    Trends getLocationTrends(int woeid) throws MixiException;
}
