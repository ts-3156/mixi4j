...
import static mixi4j.internal.http.RequestMethod.DELETE;
import static mixi4j.internal.http.RequestMethod.GET;
import static mixi4j.internal.http.RequestMethod.HEAD;
import static mixi4j.internal.http.RequestMethod.POST;
import static mixi4j.internal.http.RequestMethod.PUT;
...
public final class HttpClientWrapper implements java.io.Serializable {
    ...
    private HttpResponse request(HttpRequest req) throws MixiException {
        HttpResponse res;
        try {
    ...
    public HttpResponse get(String url, HttpParameter[] parameters
            , Authorization authorization) throws MixiException {
        return request(new HttpRequest(GET, url, parameters, authorization, this.requestHeaders));
    }

    public HttpResponse get(String url, HttpParameter[] parameters) throws MixiException {
        return request(new HttpRequest(GET, url, parameters, null, this.requestHeaders));
    }

    public HttpResponse get(String url, Authorization authorization) throws MixiException {
        return request(new HttpRequest(GET, url, null, authorization, this.requestHeaders));
    }

    public HttpResponse get(String url) throws MixiException {
    ...
    public HttpResponse post(String url, HttpParameter[] parameters) throws MixiException {
        return request(new HttpRequest(POST, url, parameters, null, this.requestHeaders));
    }

    public HttpResponse post(String url, HttpParameter[] parameters, Map<String, String> requestHeaders) throws MixiException {
    ...
    public HttpResponse post(String url, Authorization authorization) throws MixiException {
        return request(new HttpRequest(POST, url, null, authorization, this.requestHeaders));
    }

    public HttpResponse post(String url) throws MixiException {
    ...
    public HttpResponse delete(String url, HttpParameter[] parameters) throws MixiException {
    ...
    public HttpResponse delete(String url) throws MixiException {
    ...
    public HttpResponse head(String url, HttpParameter[] parameters) throws MixiException {
    ...
    public HttpResponse head(String url) throws MixiException {
    ...
    public HttpResponse put(String url, HttpParameter[] parameters) throws MixiException {
        return request(new HttpRequest(PUT, url, parameters, null, this.requestHeaders));
    }

    public HttpResponse put(String url, Authorization authorization) throws MixiException {
        return request(new HttpRequest(PUT, url, null, authorization, this.requestHeaders));
    }

    public HttpResponse put(String url) throws MixiException {
