...
public final class HttpResponseEvent {
    ...
    private MixiException twitterException;

    HttpResponseEvent(HttpRequest request, HttpResponse response, MixiException te) {
     ...
     */
    public MixiException getTwitterException() {
