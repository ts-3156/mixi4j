...
import mixi4j.Annotations;
import mixi4j.GeoLocation;
import mixi4j.HashtagEntity;
import mixi4j.MediaEntity;
import mixi4j.Place;
import mixi4j.Tweet;
import mixi4j.MixiException;
import mixi4j.URLEntity;
import mixi4j.UserMentionEntity;
...
/*package*/ final class TweetJSONImpl implements Tweet, java.io.Serializable {
    ...
    /*package*/ TweetJSONImpl(JSONObject tweet) throws MixiException {
        ...
        geoLocation = z_M4JInternalJSONImplFactory.createGeoLocation(tweet);
    ...
    /*package*/ TweetJSONImpl(JSONObject tweet, Configuration conf) throws MixiException {
        this(tweet);
