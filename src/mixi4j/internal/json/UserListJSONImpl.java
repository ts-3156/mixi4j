 ...
 */
/*package*/ class UserListJSONImpl extends MixiResponseImpl implements UserList, java.io.Serializable {
    ...
    /*package*/ UserListJSONImpl(HttpResponse res, Configuration conf) throws MixiException {
        super(res);
    ...
    /*package*/ UserListJSONImpl(JSONObject json) throws MixiException {
        super();
        init(json);
    }
    ...
    /*package*/
    static PagableResponseList<UserList> createPagableUserListList(HttpResponse res, Configuration conf) throws MixiException {
        try {
            if (conf.isJSONStoreEnabled()) {
                DataObjectFactoryUtil.clearThreadLocalMap();
            }
    ...
    /*package*/
    static ResponseList<UserList> createUserListList(HttpResponse res, Configuration conf) throws MixiException {
        try {
            if (conf.isJSONStoreEnabled()) {
                DataObjectFactoryUtil.clearThreadLocalMap();
            }
