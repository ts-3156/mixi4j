 ...
 */
class AccountTotalsJSONImpl extends MixiResponseImpl implements AccountTotals, java.io.Serializable {
    ...
    /*package*/ AccountTotalsJSONImpl(HttpResponse res, Configuration conf) throws MixiException {
    ...
    /*package*/ AccountTotalsJSONImpl(JSONObject json) throws MixiException {
        this(null, json);
    }
