 ...
 */
class AccountSettingsJSONImpl extends MixiResponseImpl implements AccountSettings, java.io.Serializable {
    ...
    private AccountSettingsJSONImpl(HttpResponse res, JSONObject json) throws MixiException {
        super(res);
        try {
    ...
    /*package*/ AccountSettingsJSONImpl(HttpResponse res, Configuration conf) throws MixiException {
    ...
    /*package*/ AccountSettingsJSONImpl(JSONObject json) throws MixiException {
        this(null, json);
    }
