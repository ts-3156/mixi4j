...
class FriendshipJSONImpl implements Friendship {
    ...
    /*package*/ FriendshipJSONImpl(JSONObject json) throws MixiException {
        super();
        try {
            id = getLong("id", json);
    ...
    /*package*/
    static ResponseList<Friendship> createFriendshipList(HttpResponse res, Configuration conf) throws MixiException {
        try {
