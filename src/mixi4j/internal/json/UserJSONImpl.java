...
import static mixi4j.internal.util.z_T4JInternalParseUtil.getBoolean;
import static mixi4j.internal.util.z_T4JInternalParseUtil.getDate;
 ...
 */
/*package*/ final class UserJSONImpl extends MixiResponseImpl implements User, java.io.Serializable {
    ...
    /*package*/UserJSONImpl(HttpResponse res, Configuration conf) throws MixiException {
        super(res);
    ...
    /*package*/UserJSONImpl(JSONObject json) throws MixiException {
        super();
        init(json);
    }
    ...
    /*package*/
    static PagableResponseList<User> createPagableUserList(HttpResponse res, Configuration conf) throws MixiException {
        try {
            if (conf.isJSONStoreEnabled()) {
                DataObjectFactoryUtil.clearThreadLocalMap();
            }
    ...
    /*package*/
    static ResponseList<User> createUserList(HttpResponse res, Configuration conf) throws MixiException {
        return createUserList(res.asJSONArray(), res, conf);
    }

    /*package*/
    static ResponseList<User> createUserList(JSONArray list, HttpResponse res, Configuration conf) throws MixiException {
        try {
            if (conf.isJSONStoreEnabled()) {
                DataObjectFactoryUtil.clearThreadLocalMap();
            }
