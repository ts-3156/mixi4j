 ...
 */
/*package*/ final class TrendsJSONImpl extends MixiResponseImpl implements Trends, java.io.Serializable {
    private Date asOf;
    ...
    TrendsJSONImpl(HttpResponse res, Configuration conf) throws MixiException {
        super(res);
    ...
    TrendsJSONImpl(String jsonStr) throws MixiException {
        this(jsonStr, false);
    }

    TrendsJSONImpl(String jsonStr, boolean storeJSON) throws MixiException {
        init(jsonStr, storeJSON);
    }

    void init(String jsonStr, boolean storeJSON) throws MixiException {
        try {
            JSONObject json;
            if (jsonStr.startsWith("[")) {
                ...
                if (array.length() > 0) {
                    ...
                    throw new MixiException("No trends found on the specified woeid");
                }
            } else {
    ...
    static ResponseList<Trends> createTrendsList(HttpResponse res, boolean storeJSON) throws
        ...
        try {
            ...
            throw new MixiException(jsone.getMessage() + ":" + res.asString(), jsone);
        }
    }

    private static Location extractLocation(JSONObject json, boolean storeJSON) throws MixiException {
