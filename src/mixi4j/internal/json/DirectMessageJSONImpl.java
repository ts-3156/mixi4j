 ...
 */
/*package*/ final class DirectMessageJSONImpl extends MixiResponseImpl implements DirectMessage, java.io.Serializable {
    ...
    /*package*/DirectMessageJSONImpl(HttpResponse res, Configuration conf) throws MixiException {
        super(res);
    ...
    /*package*/DirectMessageJSONImpl(JSONObject json) throws MixiException {
        init(json);
    }
    ...
    /*package*/
    static ResponseList<DirectMessage> createDirectMessageList(HttpResponse res, Configuration conf) throws MixiException {
        try {
            if (conf.isJSONStoreEnabled()) {
                DataObjectFactoryUtil.clearThreadLocalMap();
            }
