...
/*package*/ final class LocationJSONImpl implements Location {
    ...
    /*package*/ LocationJSONImpl(JSONObject location) throws MixiException {
        try {
    ...
    /*package*/
    static ResponseList<Location> createLocationList(HttpResponse res, Configuration conf) throws MixiException {
    ...
    /*package*/
    static ResponseList<Location> createLocationList(JSONArray list, boolean storeJSON) throws MixiException {
        try {
