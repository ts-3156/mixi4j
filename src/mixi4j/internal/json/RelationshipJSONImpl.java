 ...
 */
/*package*/ class RelationshipJSONImpl extends MixiResponseImpl implements Relationship, java.io.Serializable {
    ...
    /*package*/ RelationshipJSONImpl(HttpResponse res, Configuration conf) throws MixiException {
    ...
    /*package*/ RelationshipJSONImpl(JSONObject json) throws MixiException {
        this(null, json);
    }

    /*package*/ RelationshipJSONImpl(HttpResponse res, JSONObject json) throws MixiException {
        super(res);
        try {
    ...
    /*package*/
    static ResponseList<Relationship> createRelationshipList(HttpResponse res, Configuration conf) throws MixiException {
        try {
            if (conf.isJSONStoreEnabled()) {
                DataObjectFactoryUtil.clearThreadLocalMap();
            }
