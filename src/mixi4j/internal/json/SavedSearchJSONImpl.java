 ...
 */
/*package*/ final class SavedSearchJSONImpl extends MixiResponseImpl implements SavedSearch {
    ...
    /*package*/ SavedSearchJSONImpl(HttpResponse res, Configuration conf) throws MixiException {
        super(res);
    ...
    /*package*/ SavedSearchJSONImpl(JSONObject savedSearch) throws MixiException {
        init(savedSearch);
    }

    /*package*/
    static ResponseList<SavedSearch> createSavedSearchList(HttpResponse res, Configuration conf) throws MixiException {
        if (conf.isJSONStoreEnabled()) {
            DataObjectFactoryUtil.clearThreadLocalMap();
        }
    ...
    private void init(JSONObject savedSearch) throws MixiException {
