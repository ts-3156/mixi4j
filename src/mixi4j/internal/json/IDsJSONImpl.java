 ...
 */
/*package*/ final class IDsJSONImpl extends MixiResponseImpl implements IDs {
    ...
    /*package*/ IDsJSONImpl(HttpResponse res, Configuration conf) throws MixiException {
        super(res);
    ...
    /*package*/ IDsJSONImpl(String json) throws MixiException {
        init(json);
    }

    private void init(String jsonStr) throws MixiException {
            ...
            if (jsonStr.startsWith("{")) {
                ...
                for (int i = 0; i < idList.length(); i++) {
                    try {
                        ...
                        throw new MixiException("Twitter API returned malformed response: " + json, nfe);
                    }
                }
                ...
                for (int i = 0; i < idList.length(); i++) {
                    try {
                        ...
                        throw new MixiException("Twitter API returned malformed response: " + idList, nfe);
                    }
                }
            }
