...
final class CategoryJSONImpl implements Category, java.io.Serializable {
    ...
    static ResponseList<Category> createCategoriesList(HttpResponse res, Configuration conf) throws MixiException {
        return createCategoriesList(res.asJSONArray(), res, conf);
    }

    static ResponseList<Category> createCategoriesList(JSONArray array, HttpResponse res, Configuration conf) throws MixiException {
        try {
