 ...
 */
/*package*/ final class StatusJSONImpl extends MixiResponseImpl implements Status, java.io.Serializable {
    ...
    /*package*/StatusJSONImpl(HttpResponse res, Configuration conf) throws MixiException {
        super(res);
    ...
    /*package*/ StatusJSONImpl(JSONObject json) throws MixiException {
        super();
        init(json);
    }
    ...
    private void init(JSONObject json) throws MixiException {
        ...
        geoLocation = z_M4JInternalJSONImplFactory.createGeoLocation(json);
    ...
    /*package*/
    static ResponseList<Status> createStatusList(HttpResponse res, Configuration conf) throws MixiException {
        try {
            if (conf.isJSONStoreEnabled()) {
                DataObjectFactoryUtil.clearThreadLocalMap();
            }
