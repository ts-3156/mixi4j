 ...
 */
final class PlaceJSONImpl extends MixiResponseImpl implements Place, java.io.Serializable {
    private String name;
    ...
    /*package*/ PlaceJSONImpl(HttpResponse res, Configuration conf) throws MixiException {
        super(res);
    ...
    PlaceJSONImpl(JSONObject json, HttpResponse res) throws MixiException {
        super(res);
        init(json);
    }

    PlaceJSONImpl(JSONObject json) throws MixiException {
        super();
        init(json);
    }
    ...
    private void init(JSONObject json) throws MixiException {
        try {
            ...
            if (!json.isNull("bounding_box")) {
                ...
                boundingBoxCoordinates = z_M4JInternalJSONImplFactory.coordinatesAsGeoLocationArray(array);
            } else {
            ...
            if (!json.isNull("geometry")) {
                ...
                if (geometryType.equals("Point")) {
                    ...
                    geometryCoordinates = z_M4JInternalJSONImplFactory.coordinatesAsGeoLocationArray(array);
                } else {
    ...
    /*package*/
    static ResponseList<Place> createPlaceList(HttpResponse res, Configuration conf) throws MixiException {
