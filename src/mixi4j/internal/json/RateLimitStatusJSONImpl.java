...
/*package*/ final class RateLimitStatusJSONImpl implements RateLimitStatus, java.io.Serializable {
    ...
    RateLimitStatusJSONImpl(HttpResponse res, Configuration conf) throws MixiException {
    ...
    RateLimitStatusJSONImpl(JSONObject json) throws MixiException {
        init(json);
    }

    void init(JSONObject json) throws MixiException {
