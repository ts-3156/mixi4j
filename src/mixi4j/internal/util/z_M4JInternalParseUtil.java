...
import mixi4j.internal.http.HTMLEntity;
 ...
 */
public final class z_M4JInternalParseUtil {
     ...
     * @return
     */
    public static String getRawString2(int index, JSONArray json) {
        try {
    ...
    public static Date parseTrendsDate(String asOfStr) throws MixiException {
        Date parsed;
    ...
    public static Date getDate(String name, JSONObject json) throws MixiException {
        return getDate(name, json, "EEE MMM d HH:mm:ss z yyyy");
    }

    public static Date getDate(String name, JSONObject json, String format) throws MixiException {
...
//                // “read” (Read-only)
//                case 4:
//                    accessLevel = MixiResponse.READ;
//                    break;
//                case 10:
//                    // “read-write” (Read & Write)
//                    accessLevel = MixiResponse.READ_WRITE;
//                    break;
//                case 25:
//                    // “read-write-directmessages” (Read, Write, & Direct Message)
//                    accessLevel = MixiResponse.READ_WRITE_DIRECTMESSAGES;
//                    break;
//                case 26:
