...
import mixi4j.auth.NullAuthorization;
...
//    private List<RateLimitStatusListener> rateLimitStatusListeners = new ArrayList<RateLimitStatusListener>(0);
    ...
    /*package*/ MixiBaseImpl(Configuration conf, Authorization auth) {
        this.conf = conf;
        this.auth = auth;
        init();
    }
...
//        http.setHttpResponseListener(this);
    ...
    protected void setFactory() {
        factory = new z_M4JInternalJSONImplFactory(conf);
    }

    /**
     * {@inheritDoc}
     */
    public String getScreenName() throws MixiException, IllegalStateException {
        if (!auth.isEnabled()) {
...
//                fillInIDAndScreenName();
     ...
     * {@inheritDoc}
     */
    public long getId() throws MixiException, IllegalStateException {
        if (!auth.isEnabled()) {
            throw new IllegalStateException(
                    "Neither user ID/password combination nor OAuth consumer key/secret combination supplied");
        }
...
//    }
     ...
     * {@inheritDoc}
     */
    public RequestToken getOAuthRequestToken() throws MixiException {
     ...
     * {@inheritDoc}
     */
    public RequestToken getOAuthRequestToken(String callbackUrl) throws MixiException {
     ...
     * {@inheritDoc}
     */
    public RequestToken getOAuthRequestToken(String callbackUrl, String xAuthAccessType) throws MixiException {
     ...
     *
     * @throws MixiException When Twitter service or network is unavailable, when the user has not authorized, or when the client application is not permitted to use xAuth
     * @see <a href="https://dev.twitter.com/docs/oauth/xauth">xAuth | Twitter Developers</a>
     */
    public synchronized AccessToken getOAuthAccessToken() throws MixiException {
     ...
     */
    public synchronized AccessToken getOAuthAccessToken(String oauthVerifier) throws MixiException {
     ...
     * @throws IllegalStateException when AccessToken has already been retrieved or set
     */
    public synchronized AccessToken getOAuthAccessToken(RequestToken requestToken) throws MixiException {
     ...
     * @throws IllegalStateException when AccessToken has already been retrieved or set
     */
    public synchronized AccessToken getOAuthAccessToken(RequestToken requestToken, String oauthVerifier) throws MixiException {
    ...
    public synchronized void setOAuthMixiToken(MixiToken mixiToken) {
        getOAuth().setOAuthMixiToken(mixiToken);
    }

    /**
     * {@inheritDoc}
     */
    public synchronized AccessToken getOAuthAccessToken(String screenName, String password) throws MixiException {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MixiBaseImpl)) return false;

        MixiBaseImpl that = (MixiBaseImpl) o;
