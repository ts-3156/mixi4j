...
public interface OAuthSupport {
     ...
     */
    RequestToken getOAuthRequestToken() throws MixiException;
     ...
     * @since Twitter4J 2.0.0
     */
    RequestToken getOAuthRequestToken(String callbackURL) throws MixiException;
     ...
     */
    RequestToken getOAuthRequestToken(String callbackURL, String xAuthAccessType) throws MixiException;
     ...
     *
     * @return access token
     * @throws MixiException      when Twitter service or network is unavailable, or the user has not authorized
     ...
     * @since Twitter4J 2.0.0
     */
    AccessToken getOAuthAccessToken() throws MixiException;
     ...
     * @since Twitter4J 2.0.0
     */
    AccessToken getOAuthAccessToken(String oauthVerifier) throws MixiException;
     ...
     * @since Twitter4J 2.0.0
     */
    AccessToken getOAuthAccessToken(RequestToken requestToken) throws MixiException;
     ...
     * @since Twitter 2.1.1
     */
    AccessToken getOAuthAccessToken(RequestToken requestToken, String oauthVerifier) throws MixiException;
     ...
     * @since Twitter 2.1.1
     */
    AccessToken getOAuthAccessToken(String screenName, String password) throws MixiException;
     ...
     * @param accessToken
     */
    void setOAuthMixiToken(MixiToken mixiToken);
}
