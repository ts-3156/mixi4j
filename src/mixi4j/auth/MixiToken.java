 ...
 */
public class MixiToken extends OAuthToken implements java.io.Serializable {
    private static final long serialVersionUID = -8344528374458826291L;
    private String screenName;
    private long userId;

    MixiToken(HttpResponse res) throws MixiException {
        this(res.asString());
    }

    MixiToken(String str) {
        super(str);
    ...
    /**
     * mixiの場合はアクセストークンだけあればいい
     * @param token
     * @param tokenSecret
     */
    public MixiToken(String token, String tokenSecret) {
        super(token, tokenSecret);

        if(tokenSecret == null){
        	throw new AssertionError("MixiAccessTokenのtokenSecretはnullである必要がある");
        }
