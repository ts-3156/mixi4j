...
import mixi4j.internal.http.BASE64Encoder;
...
public class OAuthAuthorization implements Authorization, java.io.Serializable, OAuthSupport {
    ...
    public OAuthAuthorization(Configuration conf) {
        ...
        if (conf.getOAuthAccessToken() != null && conf.getOAuthAccessTokenSecret() != null) {
            setOAuthMixiToken(new MixiToken(conf.getOAuthAccessToken(), conf.getOAuthRefreshToken()));
        }
    }
     ...
     * {@inheritDoc}
     */
    public AccessToken getOAuthAccessToken() throws MixiException {
     ...
     * {@inheritDoc}
     */
    public AccessToken getOAuthAccessToken(String oauthVerifier) throws MixiException {
        ensureTokenIsAvailable();
     ...
     * {@inheritDoc}
     */
    public AccessToken getOAuthAccessToken(RequestToken requestToken) throws MixiException {
     ...
     * {@inheritDoc}
     */
    public AccessToken getOAuthAccessToken(RequestToken requestToken, String oauthVerifier) throws MixiException {
        this.oauthToken = requestToken;
     ...
     * {@inheritDoc}
     */
    public AccessToken getOAuthAccessToken(String screenName, String password) throws MixiException {
        try {
            ...
            throw new MixiException("The screen name / password combination seems to be invalid.", te, te.getStatusCode());
        }
    }
    ...
    public void setOAuthMixiToken(MixiToken accessToken) {
        this.oauthToken = accessToken;
    }
