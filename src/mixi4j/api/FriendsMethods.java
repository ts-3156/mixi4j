 ...
 */
public interface FriendsMethods {
     ...
     */
    IDs getFriendsIDs(long cursor) throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    IDs getFriendsIDs(long userId, long cursor) throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    IDs getFriendsIDs(String screenName, long cursor) throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    IDs getFollowersIDs(long cursor) throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    IDs getFollowersIDs(long userId, long cursor) throws MixiException;
     ...
     * @since Twitter4J 2.0.10
     */
    IDs getFollowersIDs(String screenName, long cursor) throws MixiException;
}
