...
//     * {@inheritDoc}
//     */
//    public User showUser(String screenName) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public PagableResponseList<User> getFriendsStatuses(long cursor) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public PagableResponseList<User> getFriendsStatuses(String screenName, long cursor) throws MixiException {
//        return factory.createPagableUserList(get(conf.getRestBaseURL()
//                + "statuses/friends.json?include_entities="
...
//     * {@inheritDoc}
//     */
//    public PagableResponseList<User> getFriendsStatuses(long userId, long cursor) throws MixiException {
//        return factory.createPagableUserList(get(conf.getRestBaseURL()
//                + "statuses/friends.json?include_entities="
//                + conf.isIncludeEntitiesEnabled() + "&user_id=" + userId
//                + "&cursor=" + cursor));
...
//     * {@inheritDoc}
//     */
//    public PagableResponseList<User> getFollowersStatuses(long cursor) throws MixiException {
//        return factory.createPagableUserList(get(conf.getRestBaseURL()
...
//     * {@inheritDoc}
//     */
//    public PagableResponseList<User> getFollowersStatuses(String screenName, long cursor) throws MixiException {
//        return factory.createPagableUserList(get(conf.getRestBaseURL()
//                + "statuses/followers.json?include_entities="
...
//     * {@inheritDoc}
//     */
//    public PagableResponseList<User> getFollowersStatuses(long userId, long cursor) throws MixiException {
//        return factory.createPagableUserList(get(conf.getRestBaseURL()
//                + "statuses/followers.json?include_entities="
...
//     * {@inheritDoc}
//     */
//    public UserList addUserListMember(int listId, long userId) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public UserList addUserListMembers(int listId, long[] userIds) throws MixiException {
//        ensureAuthorizationEnabled();
//        return factory.createAUserList(post(conf.getRestBaseURL() +
...
//     * {@inheritDoc}
//     */
//    public UserList addUserListMembers(int listId, String[] screenNames) throws MixiException {
//        ensureAuthorizationEnabled();
//        return factory.createAUserList(post(conf.getRestBaseURL() +
//                "lists/members/create_all.json",
//                new HttpParameter[]{
...
//     * {@inheritDoc}
//     */
//    public User checkUserListMembership(String listOwnerScreenName, int listId, long userId) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public User showUserListMembership(int listId, long userId) throws MixiException {
//        ensureAuthorizationEnabled();
...
//            , int listId, long cursor) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public PagableResponseList<User> getUserListSubscribers(int listId, long cursor) throws MixiException {
//        return factory.createPagableUserList(get(conf.getRestBaseURL() +
...
//     * {@inheritDoc}
//     */
//    public UserList subscribeUserList(String listOwnerScreenName, int listId) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public UserList createUserListSubscription(int listId) throws MixiException {
//        ensureAuthorizationEnabled();
//        return factory.createAUserList(post(conf.getRestBaseURL() +
...
//     * {@inheritDoc}
//     */
//    public UserList unsubscribeUserList(String listOwnerScreenName, int listId) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public UserList destroyUserListSubscription(int listId) throws MixiException {
//        ensureAuthorizationEnabled();
//        return factory.createAUserList(post(conf.getRestBaseURL() +
...
//     * {@inheritDoc}
//     */
//    public User checkUserListSubscription(String listOwnerScreenName, int listId, long userId) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public User showUserListSubscription(int listId, long userId) throws MixiException {
//        ensureAuthorizationEnabled();
//        return factory.createUser(get(conf.getRestBaseURL() +
...
//     * {@inheritDoc}
//     */
//    public ResponseList<DirectMessage> getDirectMessages() throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public ResponseList<DirectMessage> getDirectMessages(Paging paging) throws MixiException {
//        ensureAuthorizationEnabled();
//        return factory.createDirectMessageList(get(conf.getRestBaseURL()
...
//     * {@inheritDoc}
//     */
//    public DirectMessage sendDirectMessage(String screenName, String text) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public DirectMessage showDirectMessage(long id) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public User createFriendship(String screenName) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public User createFriendship(long userId) throws MixiException {
//        ensureAuthorizationEnabled();
//        return factory.createUser(post(conf.getRestBaseURL() + "friendships/create.json?include_entities="
//                + conf.isIncludeEntitiesEnabled() + "&user_id=" + userId));
//    }
...
//     * {@inheritDoc}
//     */
//    public User createFriendship(String screenName, boolean follow) throws MixiException {
//        ensureAuthorizationEnabled();
//        return factory.createUser(post(conf.getRestBaseURL() + "friendships/create.json?include_entities="
...
//     * {@inheritDoc}
//     */
//    public User createFriendship(long userId, boolean follow) throws MixiException {
//        ensureAuthorizationEnabled();
//        return factory.createUser(post(conf.getRestBaseURL() + "friendships/create.json?include_entities="
...
//     * {@inheritDoc}
//     */
//    public User destroyFriendship(String screenName) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public User destroyFriendship(long userId) throws MixiException {
//        ensureAuthorizationEnabled();
//        return factory.createUser(post(conf.getRestBaseURL() + "friendships/destroy.json?include_entities="
//                + conf.isIncludeEntitiesEnabled() + "&user_id=" + userId));
//    }
...
//     * {@inheritDoc}
//     */
//    public boolean existsFriendship(String userA, String userB) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public Relationship showFriendship(String sourceScreenName, String targetScreenName) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public Relationship showFriendship(long sourceId, long targetId) throws MixiException {
//        return factory.createRelationship(get(conf.getRestBaseURL() + "friendships/show.json",
//                new HttpParameter[]{
...
//     * {@inheritDoc}
//     */
//    public IDs getIncomingFriendships(long cursor) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public IDs getOutgoingFriendships(long cursor) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public ResponseList<Friendship> lookupFriendships(String[] screenNames) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public ResponseList<Friendship> lookupFriendships(long[] ids) throws MixiException {
//        ensureAuthorizationEnabled();
...
//            , boolean retweets) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public IDs getFollowersIDs(long cursor) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public IDs getFollowersIDs(long userId, long cursor) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public IDs getFollowersIDs(String screenName, long cursor) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public User verifyCredentials() throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public RateLimitStatus getRateLimitStatus() throws MixiException {
...
//            , String location, String description) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public AccountTotals getAccountTotals() throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public AccountSettings getAccountSettings() throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public ResponseList<Status> getFavorites(int page) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public ResponseList<Status> getFavorites(String id) throws MixiException {
//        ensureAuthorizationEnabled();
//        return factory.createStatusList(get(conf.getRestBaseURL()
...
//     * {@inheritDoc}
//     */
//    public ResponseList<Status> getFavorites(String id, int page) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public IDs getBlockingUsersIDs() throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public User reportSpam(long userId) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public User reportSpam(String screenName) throws MixiException {
//        ensureAuthorizationEnabled();
//        return factory.createUser(post(conf.getRestBaseURL() + "report_spam.json?include_entities="
//                + conf.isIncludeEntitiesEnabled() + "&screen_name=" + screenName));
//    }
...
//     * {@inheritDoc}
//     */
//    public ResponseList<SavedSearch> getSavedSearches() throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public SavedSearch showSavedSearch(int id) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public SavedSearch createSavedSearch(String query) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public SavedSearch destroySavedSearch(int id) throws MixiException {
//        ensureAuthorizationEnabled();
...
//     * {@inheritDoc}
//     */
//    public ResponseList<Location> getAvailableTrends() throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public ResponseList<Location> getAvailableTrends(GeoLocation location) throws MixiException {
//        return factory.createLocationList(get(conf.getRestBaseURL()
//                + "trends/available.json",
...
//     * {@inheritDoc}
//     */
//    public Trends getLocationTrends(int woeid) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public ResponseList<Place> searchPlaces(GeoQuery query) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public SimilarPlaces getSimilarPlaces(GeoLocation location, String name, String containedWithin, String streetAddress) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public ResponseList<Place> reverseGeoCode(GeoQuery query) throws MixiException {
//        try {
//            return factory.createPlaceList(get(conf.getRestBaseURL()
...
//     * {@inheritDoc}
//     */
//    public Place getGeoDetails(String id) throws MixiException {
...
//     * {@inheritDoc}
//     */
//    public Place createPlace(String name, String containedWithin, String token, GeoLocation location, String streetAddress) throws MixiException {
//        ensureAuthorizationEnabled();
//        List<HttpParameter> params = new ArrayList<HttpParameter>(3);
//        params.add(new HttpParameter("name", name));
//        params.add(new HttpParameter("contained_within", containedWithin));
...
//     * {@inheritDoc}
//     */
//    public String getTermsOfService() throws MixiException {
//        try {
//            return get(conf.getRestBaseURL() + "legal/tos.json").asJSONObject().getString("tos");
//        } catch (JSONException e) {
//            throw new MixiException(e);
//        }
//    }
     ...
     * {@inheritDoc}
     */
    public String getPrivacyPolicy() throws MixiException {
        try {
     ...
     * {@inheritDoc}
     */
    public boolean test() throws MixiException {
    ...
    private HttpResponse get(String url) throws MixiException {
    ...
    private HttpResponse get(String url, HttpParameter[] parameters) throws MixiException {
        if (!conf.isMBeanEnabled()) {
    ...
    private HttpResponse post(String url) throws MixiException {
        if (!conf.isMBeanEnabled()) {
    ...
    private HttpResponse post(String url, HttpParameter[] parameters) throws MixiException {
        if (!conf.isMBeanEnabled()) {
    ...
    private HttpResponse delete(String url) throws MixiException {
        if (!conf.isMBeanEnabled()) {
