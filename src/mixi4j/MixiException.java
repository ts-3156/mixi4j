...
//public class MixiException extends Exception implements MixiResponse, HttpResponseCode {
    ...
    public MixiException(String message, Throwable cause) {
        super(message, cause);
        decode(message);
    }

    public MixiException(String message) {
        this(message, (Throwable) null);
    }


    public MixiException(Exception cause) {
        this(cause.getMessage(), cause);
        if (cause instanceof MixiException) {
            ((MixiException) cause).setNested();
        }
    }

    public MixiException(String message, HttpResponse res) {
        this(message);
        response = res;
        this.statusCode = res.getStatusCode();
    }

    public MixiException(String message, Exception cause, int statusCode) {
        this(message, cause);
...
//    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MixiException)) return false;

        MixiException that = (MixiException) o;
