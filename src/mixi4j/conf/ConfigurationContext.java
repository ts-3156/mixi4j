...
public final class ConfigurationContext {
    public static final String DEFAULT_CONFIGURATION_FACTORY = "mixi4j.conf.PropertyConfigurationFactory";
    public static final String CONFIGURATION_IMPL = "mixi4j.configurationFactory";
