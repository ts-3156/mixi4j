...
//    private static final String DEFAULT_REST_BASE_URL = "http://api.twitter.com/1/";
    private static final String DEFAULT_REST_BASE_URL = "https://api.mixi-platform.com/2/";
    ...
    protected ConfigurationBase() {
        ...
        setOAuthAuthorizationCode(null);
    ...
    public int hashCode() {
        ...
        result = 31 * result + (oAuthRefreshToken != null ? oAuthRefreshToken.hashCode() : 0);
        result = 31 * result + (oAuthAuthorizationCode != null ? oAuthAuthorizationCode.hashCode() : 0);
    ...
    public boolean equals(Object o) {
        ...
        if (oAuthRefreshToken != null ? !oAuthRefreshToken.equals(that.oAuthRefreshToken) : that.oAuthRefreshToken != null)
            return false;
        if (oAuthAuthorizationCode != null ? !oAuthAuthorizationCode.equals(that.oAuthAuthorizationCode) : that.oAuthAuthorizationCode != null)
            return false;
        if (oAuthRedirectURL != null ? !oAuthRedirectURL.equals(that.oAuthRedirectURL) : that.oAuthRedirectURL != null)
            return false;
