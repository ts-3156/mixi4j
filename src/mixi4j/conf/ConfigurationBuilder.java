...
public final class ConfigurationBuilder {
    ...
    // added for mixi4j
    public ConfigurationBuilder setOAuthRefreshToken(String oAuthRefreshToken) {
        checkNotBuilt();
        configurationBean.setOAuthRefreshToken(oAuthRefreshToken);
        return this;
    }

    // added for mixi4j
    public ConfigurationBuilder setOAuthAuthorizationCode(String oAuthAuthorizationCode) {
        checkNotBuilt();
        configurationBean.setOAuthAuthorizationCode(oAuthAuthorizationCode);
        return this;
    }
