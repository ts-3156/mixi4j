...
public final class DataObjectFactory {
     ...
     * @return Status
     * @throws MixiException when provided string is not a valid JSON string.
     * @since Twitter4J 2.1.7
     */
    public static Status createStatus(String rawJSON) throws MixiException {
        try {
     ...
     * @since Twitter4J 2.1.7
     */
    public static User createUser(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
     ...
     */
    public static AccountTotals createAccountTotals(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
     ...
     * @since Twitter4J 2.1.7
     */
    public static Tweet createTweet(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
     ...
     * @since Twitter4J 2.1.7
     */
    public static Relationship createRelationship(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
     ...
     * @since Twitter4J 2.1.7
     */
    public static Place createPlace(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
     ...
     * @since Twitter4J 2.1.7
     */
    public static SavedSearch createSavedSearch(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
     ...
     * @since Twitter4J 2.1.7
     */
    public static Trend createTrend(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
     ...
     * @since Twitter4J 2.1.7
     */
    public static Trends createTrends(String rawJSON) throws MixiException {
        try {
     ...
     * @since Twitter4J 2.1.7
     */
    public static IDs createIDs(String rawJSON) throws MixiException {
        try {
     ...
     * @since Twitter4J 2.1.7
     */
    public static RateLimitStatus createRateLimitStatus(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
     ...
     * @since Twitter4J 2.1.7
     */
    public static Category createCategory(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
     ...
     * @since Twitter4J 2.1.7
     */
    public static DirectMessage createDirectMessage(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
     ...
     * @since Twitter4J 2.1.7
     */
    public static Location createLocation(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
     ...
     * @since Twitter4J 2.1.7
     */
    public static UserList createUserList(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
     ...
     */
    public static RelatedResults createRelatedResults(String rawJSON) throws MixiException {
        try {
     ...
     * @since Twitter4J 2.1.9
     */
    public static Object createObject(String rawJSON) throws MixiException {
        try {
            JSONObject json = new JSONObject(rawJSON);
